...
const PRODUCTS = Object.freeze([
  p("MAT-000227", "Грунтовка Knauf Тифенгрунд 5 кг", "KNAUF", withPackage(commonReady("knaufTiefengrund", "KNAUF", "Грунтовка глубокого проникновения", "Полимерная дисперсия", "Укрепление основания, снижение впитываемости и улучшение адгезии", "Внутренние и наружные работы", "ГКЛ/ГВЛ, гипсовые и цементные штукатурки, ПГП, стяжки", { primerType: "Глубокого проникновения", consumption: "0,1 кг/м²", drying: "3 часа", color: "Белый", shelfLife: 12 }), { package_weight: ready(5, ["knaufTiefengrund"]), package_volume: need("Official source confirms 5 kg packaging; volume is not inferred.", ["knaufTiefengrund"]) }), { sourceKeys: ["knaufTiefengrund", ...local], titleStatus: "TITLE_UNIT_CONFIRMED" }),
  p("MAT-000228", "Грунтовка Knauf Тифенгрунд 10 кг", "KNAUF", withPackage(commonReady("knaufTiefengrund", "KNAUF", "Грунтовка глубокого проникновения", "Полимерная дисперсия", "Укрепление основания, снижение впитываемости и улучшение адгезии", "Внутренние и наружные работы", "ГКЛ/ГВЛ, гипсовые и цементные штукатурки, ПГП, стяжки", { primerType: "Глубокого проникновения", consumption: "0,1 кг/м²", drying: "3 часа", color: "Белый", shelfLife: 12 }), { package_weight: ready(10, ["knaufTiefengrund"]), package_volume: need("Official source confirms 10 kg packaging; volume is not inferred.", ["knaufTiefengrund"]) }), { sourceKeys: ["knaufTiefengrund", ...local], titleStatus: "TITLE_UNIT_CONFIRMED" }),
  p("MAT-000230", "Грунтовка Knauf Мульти Грунд универсальный 10 кг", "KNAUF", withPackage(commonReady("knaufMultigrund", "KNAUF", "Универсальная грунтовка для впитывающих оснований", "Полимерная дисперсия", "Снижение и регулирование впитываемости, улучшение адгезии", "Внутренние и наружные работы", "Газо- и пенобетон, кирпич, штукатурки, стяжки", { primerType: "Универсальная для впитывающих оснований", consumption: "0,2 кг/м²", drying: "6 часов", color: "Жёлтый", shelfLife: 12 }), { package_weight: ready(10, ["knaufMultigrund"]), package_volume: need("Official source confirms 10 kg packaging; volume is not inferred.", ["knaufMultigrund"]) }), { sourceKeys: ["knaufMultigrund", ...local], titleStatus: "TITLE_UNIT_CONFIRMED" }),
  ...
  p("MAT-000240", "Грунтовка Knauf Миттельгрунд для впитывающих оснований концентрат 10 кг", "KNAUF", withPackage(commonReady("knaufMittelgrund", "KNAUF", "Грунтовка-концентрат для впитывающих оснований", "Полимерная дисперсия с жёлтым пигментом", "Снижение и регулирование впитываемости, подготовка под штукатурки, плитку и стяжки", "Внутренние и наружные работы", "Газо- и пенобетон, кирпич, штукатурки, бетонные и гипсовые стяжки", { primerType: "Концентрат для впитывающих оснований", consumption: "0,05 кг/м² концентрата; раствор зависит от основания", drying: "6 часов", dilution: "1:3–1:5 в зависимости от основания", concentrate: true, color: "Жёлтый", shelfLife: 12 }), { package_weight: ready(10, ["knaufMittelgrund"]), package_volume: need("Official source confirms 10 kg packaging; volume is not inferred.", ["knaufMittelgrund"]) }), { sourceKeys: ["knaufMittelgrund", ...local], titleStatus: "TITLE_UNIT_CONFIRMED" }),
