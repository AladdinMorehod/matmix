...
const PRODUCTS = Object.freeze([
  ...
  p("MAT-000232", "Грунтовка Ceresit CT-17 PRO, 10л", "Ceresit", withPackage(commonReady("ceresitCt17", "Ceresit", "Грунтовка глубокого проникновения", "Водная дисперсия сополимеров акрилатов", "Укрепление, связывание пыли, снижение впитываемости и повышение адгезии", "Внутренние и наружные работы", "Цементные, известковые и гипсовые штукатурки, стяжки, бетон, кирпич, ГКЛ, ДСП/ДВП", { primerType: "Глубокого проникновения", consumption: "0,1–0,2 л/м²", drying: "до 2 часов", color: "Светло-жёлтый", temperature: "0…+35 °C" }), { package_weight: absent("Source specifies this liquid SKU in litres; mass is not provided.", ["ceresitCt17"]), package_volume: ready(10, ["ceresitCt17"]) }), { sourceKeys: ["ceresitCt17", ...local], titleStatus: "MATCH" }),
