...
(async () => {
    ...
    try {
        ...
        assert.strictEqual(result.data.content.product.brand, "Knauf"); assert.strictEqual(result.data.content.values.length, 6); assert.strictEqual(result.data.content.values.find(item => item.definitionId === numberDefinition).value, 25);
